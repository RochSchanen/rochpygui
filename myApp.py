...
class myApp(baseApp):
	...
	def Start(self):
		...
		w , h = 200, 200
		self.Frame.Panel.BackgroundBitmap = wx.EmptyBitmap(w, h)
		
		dc = wx.MemoryDC()
		dc.SelectObject(self.Frame.Panel.BackgroundBitmap)

		# Bitmap = Decorations.GetBitmap('Any', 100, 150)
		# Bitmap = Decorations.GetBitmap('Ridge', 100, 150)
		# Bitmap = Decorations.GetBitmap('Groove', 100, 150)
		# Bitmap = Decorations.GetBitmap('Outset', 100, 150)
		Bitmap = Decorations.GetBitmap('Inset', 100, 150)
